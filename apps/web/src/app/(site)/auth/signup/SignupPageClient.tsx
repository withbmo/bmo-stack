...
import { useAuthForm } from '@/common/features/auth/hooks/useAuthForm';
import {
  signup,
...
import type { ApiError } from '@/common/lib/auth';
import { getOtpMeta } from '@/common/features/auth/utils/otp';
...
import { EmailField, UsernameField, FullNameField, PasswordField } from '@/common/auth/FormFields';
import { AuthSubmitButton } from '@/common/auth/AuthSubmitButton';
import { SocialAuthButtons } from '@/common/auth/SocialAuthButtons';

const TURNSTILE_SITE_KEY = process.env.NEXT_PUBLIC_TURNSTILE_SITE_KEY ?? '';
const IS_DEV = process.env.NODE_ENV === 'development';

/**
 * Signup page client component - handles new user registration
 * After successful signup, navigates to OTP verification page
 */
    ...
    >
      ...
      <AuthCard>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Username Field */}
          <UsernameField value={username} onChange={setUsername} error={fieldErrors.username} />

          {/* Full Name Field */}
          <FullNameField value={fullName} onChange={setFullName} error={fieldErrors.full_name} />
